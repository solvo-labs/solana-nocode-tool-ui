...
// import { StreamClient, Cluster, BN, getBN, StreamType, StreamDirection, getNumberFromBN } from "@streamflow/stream";
...
//     depositedAmount: getBN(100, mint.decimal), // depositing 100 tokens with 9 decimals mint.
//     period: 1, // Time step (period) in seconds per which the unlocking occurs.
//     cliff: getTimestamp() + 120, // Vesting contract "cliff" timestamp in seconds.
//     cliffAmount: new BN(10, mint.decimal), // Amount unlocked at the "cliff" timestamp.
...
// export const withdraw = async (wallet: AnchorWallet, id: string, amountComing: number, decimals: number) => {
