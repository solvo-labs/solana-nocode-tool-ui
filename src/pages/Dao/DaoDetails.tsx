...
const DaoDetails: React.FC = () => {
    ...
    const init = async () => {
      if (daoInstance && pubkey) {
        try {
          ...
          console.log(proposalMain[0].account.accountType == GovernanceAccountType.ProposalV2);
  ...
  return (
    <Grid container direction={"row"} spacing={2} width={"90vw"} display={"flex"} alignContent={"center"} marginTop={"4rem"}>
        ...
        <Card className={classes.card}>
          <CardContent className={classes.cardContent}>
            ...
            <Stack direction={"row"} marginTop={"1rem"} spacing={2} display={"flex"} alignItems={"center"}>
              ...
              <FilterSelector filters={filters} selectedFilter={selectedFilter} setFilter={() => setSelectedFilter}></FilterSelector>
            </Stack>
            ...
            <Stack direction={"column"} marginTop={"1rem"}>
              <ExecutableProposalCard></ExecutableProposalCard>
              <NonExecutableProposalCard></NonExecutableProposalCard>
            </Stack>
